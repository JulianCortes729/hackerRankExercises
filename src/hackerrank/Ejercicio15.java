...
tags meeting the following criterion:
   1- The name of the start and end tags must be same. The HTML
      code <h1>Hello World</h2> is not valid, because the text starts
      with an h1 tag and ends with a non-matching h2 tag.

   2- Tags can be nested, but content between nested tags is
      considered not valid. For example, in <h1>
      <a>contents</a>invalid</h1>, contents is valid but
...
public class Ejercicio15 {
    ...
    public static void main(String[] args) {
        ...
        while(testCases > 0) {
            ...
            // <(.+)> ------ grupo 1 detro de < > se acepta todo y tiene que estar 1 o mas veces
            // </\\1*> --------- grupo 3 detro de < > se acepta lo mismo que en el grupo 1 y se tiene que repetir al menos una vez mas (los grupos estan definidos por los parentesis)
            // ([^<>]+) --------- grupo 2 se acepta todo menos los signos < > y tiene que estar al menos una vez
